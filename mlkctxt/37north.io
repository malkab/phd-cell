...
export MLKC_CELL_DB_USER_CELL_MASTER=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_MASTER
export MLKC_CELL_DB_PASS_CELL_MASTER=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_MASTER
export MLKC_CELL_DB_USER_CELL_READONLY=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_READONLY
export MLKC_CELL_DB_PASS_CELL_READONLY=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_READONLY
