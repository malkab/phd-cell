...
export class IPolyPercentAreaOperator extends AggOperator {
    ...
    //             // Check number of child cells

    //             const numChilds: number = gridderJob.grid.numChildCells(cell.zoom, lastZoom);
    ...
    //                 this._childSubJobs(gridderSubJob, currentZoomIndex + 1,
    //                     null);
