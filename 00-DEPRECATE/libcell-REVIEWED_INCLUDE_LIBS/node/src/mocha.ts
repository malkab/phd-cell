...
import * as f from "../package-DEPRECATGE/ipersistable-DEPRECATE";
import { CellObject } from "./libcell/cellobject";
...
import { PgConnection, IPgConnection } from "../package-DEPRECATGE/REWORK-DEPRECATE/pgconnection";
import { Catalog, ICatalog } from "../package-DEPRECATGE/REWORK-DEPRECATE/catalog";
import { Variable, IVariable } from "../package-DEPRECATGE/REWORK-DEPRECATE/variable";
import { GridderJob, IGridderJob } from "../package-DEPRECATGE/REWORK-DEPRECATE/gridderjob";
...
describe("CellObject", () => {
    ...
    // let a: CellObject = f.(init);

    // console.log("D: a", a);

    // let a: CellObject = new CellObject(init);
    ...
    // it("Bad init", () => {
    //     expect(() => { let a: CellObject = new CellObject(null); } ).throws(Error, "Unable to create CellObject: no id");
    // });
