...
import { Grid } from "../../package-DEPRECATGE/REWORK-DEPRECATE/grid";
import { Cell, ICell } from "../../package-DEPRECATGE/REWORK-DEPRECATE/cell";
import { Variable } from "./variable";
import { IPersistable } from "../../package-DEPRECATGE/ipersistable-DEPRECATE";
import { getHash } from "./utils";
import { GridderSubJob, IGridderSubJob, EGridderSubJobProcessingType } from "../../package-DEPRECATGE/REWORK-DEPRECATE/griddersubjob";
...
export interface IGridderJob extends ICellObject {
    ...
    /**
     *
     * This is the zoom level where the gridder starts using an
     * in-memory drill down strategy
     *
     * */

    processingthresholdzoomlevel: number;
    
    /** The cell defining the dirty area to work on */
...
export class GridderJob extends CellObject implements IPersistable {
    ...
    */
    ...
    // Processing threshold zoom level where the gridder switches to an
    // in-memory drill-down strategy

    private _processingThresholdZoomLevel: number;
    ...
    */
    ...
    get persist(): IGridderJob {
        ...
        (<IGridderJob>base).processingthresholdzoomlevel = 
            this._processingThresholdZoomLevel;
    ...
    get processingThresholdZoomLevel(): number {

        return this._processingThresholdZoomLevel;
    ...
    */
    ...
    constructor(id: string, init: IGridderJob) {
        ...
        this._processingThresholdZoomLevel =
            init.processingthresholdzoomlevel;
