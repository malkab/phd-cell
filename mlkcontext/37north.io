...
export MLKC_CELL_DB_USER_MASTER=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_MASTER
export MLKC_CELL_DB_PASS_MASTER=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_MASTER
export MLKC_CELL_DB_USER_READONLY=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_READONLY
export MLKC_CELL_DB_PASS_READONLY=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_READONLY
...
export MLKC_CELL_RAW_DATA_USER_MASTER=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_MASTER
export MLKC_CELL_RAW_DATA_PASS_MASTER=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_MASTER
export MLKC_CELL_RAW_DATA_USER_READONLY=$MLKC_SYSTEM_37NORTH_PG_USER_CELL_READONLY
export MLKC_CELL_RAW_DATA_PASS_READONLY=$MLKC_SYSTEM_37NORTH_PG_PASS_CELL_READONLY
