...
export class CellError extends Error {
  ...
  */
  ...
  private _originalMessage: string | undefined;
  private _stack: any;
  ...
  */
  get code(): ECellErrorCode { return this._code; }

  get message(): string { return this._message; }

  get originalMessage(): string | undefined { return this._originalMessage; }
  ...
  */
  constructor({
    ...
    if (error) {
      ...
      this._originalMessage = undefined;
